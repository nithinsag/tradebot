...
class CustomEnv:
    ...
    def step(self, action):
        ...
        current_price = random.uniform(
            ...
            self.df.loc[self.current_step, 'Close'])
        Date = self.df.loc[self.current_step, 'Opentime']  # for visualization
    ...
    def render(self, visualize=False):
        ...
        if visualize:
            Date = self.df.loc[self.current_step, 'Opentime']
...
Random_games(test_env, visualize=True,
             train_episodes=1, training_batch_size=300)
